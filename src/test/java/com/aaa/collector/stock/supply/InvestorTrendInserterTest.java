...
@DisplayName("InvestorTrendInserter 단위 테스트 (REQ-OBSV-023 AC-5 배치 경로)")
class InvestorTrendInserterTest {
    ...
    private InvestorTrend entity() {
        return InvestorTrend.builder()
                ...
                .foreignNetQty(1L)
                .institutionNetQty(1L)
                .individualNetQty(1L)
                .foreignNetValue(1L)
                .institutionNetValue(1L)
                .individualNetValue(1L)
                .totalVolume(1L)
                .totalTradingValue(1L)
                .build();
    }
