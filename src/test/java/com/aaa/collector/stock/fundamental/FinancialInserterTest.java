...
@DisplayName("FinancialInserter 단위 테스트 (REQ-OBSV-023 AC-5 배치 경로)")
class FinancialInserterTest {
    ...
    private Financial entity() {
        return Financial.builder()
                ...
                .periodDate(LocalDate.of(2025, 12, 1))
                .build();
    }
    ...
    class EmptyList {
        ...
        void emptyRows_noJdbcNoMetric() {
            FinancialInserter inserter = new FinancialInserter(jdbcTemplate, batchMetrics);
