 ...
 *
 * <p>구 정적 라운드로빈 분배(KISGATE-001로 제거됨)의 "빈 할당" 신호의 lease 등가물이다. 가짜 키를 lease하지 않고 명시적 예외로 전 키 사망을 알려,
 * 호출부가 기존 전 키 사망 정책(per-call 0회 수행 + skip-all + ERROR 로그, REQ-KEYDIST-020)을 적용하도록 한다.
 *
